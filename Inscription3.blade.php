		...
		<div class="form-step js-form-step" data-step="1">
          ...
          <h4 style="display: inline;margin: 31px"> Doctor </h4><input type="radio" onclick="disablebtn();myFunction2()" name="type" v-model="type" id="Doctor"/> 
			...
			<div class="form-step js-form-step waiting hidden" data-step="2">
				...
				<p class="form-instructions"><strong><h2>Donnés personnel</h2></strong>
						<br></p>
				...
				action="/verif" 
				method="post"
				name="form-step-2" onsubmit="return validateForm()">
				<p v-if="errors.length">
					...
					<div id="f2" class="form-col">
							...
							<p  id="text" style="display:none; font-weight: bold;color:red">vous etes un étudiant </p>
							<p id="text2" style="display:none;font-weight: bold;color:red">vous etes un Doctor  </p>
					</div>
					...
					<div class="fieldgroup">
									...
									<h4>Specialité:</h4>
	<input type="text" placeholder="choisir votre Specialité" list="specialite" name="specialite">
            <datalist id="specialite">
          <option value="commerce et comptabilité"></option>
					<option value="statistique et analyse de l'information"></option>
					<option value="Industries Alimentaires"></option>
					<option value="sciences de gestion"></option>
					<option value="sciences de l'ingénieur"></option>
					<option value="Pêche et Aquaculture"></option>
					<option value="Génie Rural eaux et forêts"></option>
					<option value="Hydraulique et aménagement rural"></option>
					<option value="Droit public"></option>
					<option value="Télécommnication"></option>
					<option value="Informatique industriel et automatique"></option>
					<option value="Instrumentation et mesures industrielles"></option>
					<option value="Génie logiciels"></option>
					<option value="Chimie et Biologie"></option>
					<option value="Architecture"></option>
					<option value="Statistique"></option>
					<option value="Ingénieur Polytechnicien (EPT)"></option>
					<option value="Sciences Agronomiques"></option>
					<option value="audio-visuel"></option>
					<option value="Urbanisme et aménagement"></option> </datalist>
				</div>
						<div class="buttons">
								<button type="button" class="btn btn-alt js-reset">reprendre</button>
			...
			<div class="form-step js-form-step waiting hidden" data-step="3">
				...
				<p class="form-instructions"><strong>Veuillez repondre</strong>
		...
		<!-- Step four -->
			<div class="form-step js-form-step waiting hidden" data-step="4">
				...
				<p class="form-instructions"><strong><h2>Veuillez repondre</h2></strong>
						<br> </p>
...
function submitform() {
    var1=document.getElementById("Etudiant");
     ...
     {
				document.getElementById("thediv").innerHTML = '<div class="fieldgroup"><h3>nombre d"annees en these </h3><select ></br> <option value="1" disabled>1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5" disabled>5</option><option value="6" disabled>6</option><option value="7" disabled>7</option></select></div>';
			}
     else
     {
        document.getElementById("thediv").innerHTML = '<div class="fieldgroup"><h5>Combien d années avez-vous passé dans la thése :</h5><input type="Number" min="1" max="7" name="Thése1" id="these1" /></div><div class="fieldgroup"><h5>Date soutenance de thèse :</h5><input type="Date" name="datesout" id="datesout" /></div><div class="fieldgroup"><h5>Nombre d inscrits en thèse :</h5> <input type="Number" min="1" max="7" name="nbrinscri" id="nbrinscri" /></div>';
     }
}
/**
