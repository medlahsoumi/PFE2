...
@section('head')
		...
		<link href="css2/owl.theme.default.min.css"  rel="stylesheet">
...
@endsection
	...
	<body id="page-top">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header page-scroll">
					...
					<a href="#page-top"><img id="img"src="/img/logoUC.gif" alt=""></a>
				</div>
		...
		<script src="js2/cbpAnimatedHeader.js"></script>
		<script src="js2/jquery.appear.js"></script>
		<script src="js2/SmoothScroll.min.js"></script>
		<script src="js2/mooz.themes.scripts.js"></script>
	@endsection()
